                ...
                <div className="flex">
                    ...
                    <div className="w-3/4 lg:w-5/6 relative">
                        ...
                        <form onSubmit={sendMessage} className="flex items-center h-12 md:h-14 w-full sticky bottom-0 p-2 bg-gray-200 text-xs md:text-sm" autoComplete="off">
                            ...
                            <button type="submit" className="px-5 py-2 transition bg-gray-800 active:bg-gray-700 text-white rounded ml-3 focus:outline-none disabled:opacity-50" disabled={(!connectedRooms.includes(currentChat.chatName) && currentChat.isChannel)}>
                                Send
                            </button>
                        </form>
                    </div>
